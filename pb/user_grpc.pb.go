...
type UserServiceClient interface {
	...
	AddUserReturnStream(ctx context.Context, in *User, opts ...grpc.CallOption) (UserService_AddUserReturnStreamClient, error)
...
func (c *userServiceClient) AddUserReturnStream(ctx context.Context, in *User, opts ...grpc.CallOption) (UserService_AddUserReturnStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[0], "/pb.UserService/AddUserReturnStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &userServiceAddUserReturnStreamClient{stream}
...
type UserService_AddUserReturnStreamClient interface {
	Recv() (*UserResultStream, error)
	grpc.ClientStream
}

type userServiceAddUserReturnStreamClient struct {
	grpc.ClientStream
}

func (x *userServiceAddUserReturnStreamClient) Recv() (*UserResultStream, error) {
...
func (c *userServiceClient) AddUserStream(ctx context.Context, opts ...grpc.CallOption) (UserService_AddUserStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[2], "/pb.UserService/AddUserStream", opts...)
	if err != nil {
		return nil, err
	}
...
type UserServiceServer interface {
	...
	AddUserReturnStream(*User, UserService_AddUserReturnStreamServer) error
...
func (UnimplementedUserServiceServer) AddUserReturnStream(*User, UserService_AddUserReturnStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method AddUserReturnStream not implemented")
}
...
func _UserService_AddUserReturnStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(User)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(UserServiceServer).AddUserReturnStream(m, &userServiceAddUserReturnStreamServer{stream})
}

type UserService_AddUserReturnStreamServer interface {
	Send(*UserResultStream) error
	grpc.ServerStream
}

type userServiceAddUserReturnStreamServer struct {
	grpc.ServerStream
}

func (x *userServiceAddUserReturnStreamServer) Send(m *UserResultStream) error {
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "AddUserReturnStream",
			Handler:       _UserService_AddUserReturnStream_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "AddUsers",
